...
module "my_instance" {
    ...
    ebs_volumes = concat([
        {name:"transaction-log", device_name:var.vol_trans_log_device_name, encrypted:false, kms_key_id="", size:var.vol_trans_log_size, type:"gp2", tags:{}},
        {name:"storage", device_name:var.vol_storage_device_name, encrypted:false, kms_key_id="", size:var.vol_storage_size, type:"gp2", tags:{}}
